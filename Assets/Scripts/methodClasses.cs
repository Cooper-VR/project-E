...
public class methodClasses
{
	...
	public Vector3 getRandomSpawn(spawner spawnData, Vector3 position, Terrain terrainCollider)
    {
        ...
        Vector3 newPosition = checkPosition(xSpawn, ySpawn, terrainCollider);
    ...
    public Vector3 checkPosition(float x, float y, Terrain terrainCollider)
    {
        RaycastHit hit;
    ...
    public void onExplosions(explosionData explosionData, ParticleSystem rootParticle, Vector3 Position, Terrain terrainCollider)
    {
        ...
        for (int i = 0; i < allDamagers.Length; i++)
        {
            ...
            {
                Vector3 position = this.checkPosition(Position, terrainCollider);
